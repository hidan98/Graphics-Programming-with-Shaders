...
HightMapSphereShader::HightMapSphereShader(ID3D11Device* device, HWND hwnd) : BaseShader(device, hwnd)
{
	initShader(L"sphere_vs.cso", L"sphere_ds.cso", L"sphere_hs.cso", L"sphere_ps.cso");
}


HightMapSphereShader::~HightMapSphereShader()
{
...
void HightMapSphereShader::initShader(WCHAR* vsFilename, WCHAR* psFilename)
{
...
void HightMapSphereShader::initShader(WCHAR* vsFilename, WCHAR* dsFilename, WCHAR* hsFilename, WCHAR* psFilename)
{
...
void HightMapSphereShader::customeLoad(WCHAR* filename)
{
